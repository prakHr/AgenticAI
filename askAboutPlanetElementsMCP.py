...
@app.get("/askAboutPlanetElements_type1/",operation_id="get_planet_elements_api_1")
...
@app.get("/askAboutPlanetElements_type2/",operation_id="get_planet_elements_api_2")
...
if __name__=="__main__":
    mcp = FastApiMCP(app,include_operations = ["get_planet_elements_api_1","get_planet_elements_api_2"])
    mcp.mount_http()
    import uvicorn
