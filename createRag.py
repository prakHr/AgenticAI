...
def create_rag_pipeline(
    ...
    client.create_payload_index(collection_name=COLLECTION_NAME,field_name="source",field_schema=PayloadSchemaType.KEYWORD)
    ...
    original_texts = [document["original_text"] for document in documents]
    ...
    embeddings = embedding_model.encode(original_texts,show_progress_bar=True)
    ...
    for result in results:
        document_text = (result.payload["original_text"])
        rerank_candidates.append((query,document_text))
...
if __name__ == "__main__":
    ...
    for index, result in enumerate(results,start=1):
        ...
        print("Pages:",payload.get("page_numbers"))
        print("Start Page:",payload.get("start_page"))
        print("End Page:",payload.get("end_page"))
        print("Chunk:",payload.get("chunk_index"))
        print("\nSUMMARY:")
        print(payload.get("text"))
        print("\nORIGINAL CHUNK:")
        print(payload.get("original_text"))