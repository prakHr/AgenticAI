# uvicorn universalManual:app --reload
...
@app.get("/universalManual/",operation_id="get_universalManual")
def read_item(model:str,universal_type:str):
    results = run_universalManual_execution(universal_type,model)
    return results



if __name__=="__main__":
    mcp = FastApiMCP(app,include_operations = ["get_universalManual"])
    mcp.mount_http()
    import uvicorn
