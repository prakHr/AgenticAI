# uvicorn suggestGymExercises:app --reload
...
@app.get("/suggestGymExercises/",operation_id="suggestGymExercises")
...
if __name__=="__main__":
    mcp = FastApiMCP(app,include_operations = ["suggestGymExercises"])
    mcp.mount_http()
    import uvicorn
