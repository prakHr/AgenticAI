# uvicorn videoLinksSuggestions:app --reload
...
@app.get("/videoLinksSuggestions/",operation_id="get_videoLinksSuggestions")
...
if __name__=="__main__":
    mcp = FastApiMCP(app,include_operations = ["get_videoLinksSuggestions"])
    mcp.mount_http()
    import uvicorn
