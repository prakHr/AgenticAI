# uvicorn askAboutElement:app --reload
...
@app.get("/askAboutElement/",operation_id="get_element")
def read_item(model:str,element_name:str):
    results = run_askElementDetails_execution(element_name,model)
    return results

if __name__=="__main__":
    mcp = FastApiMCP(app,include_operations = ["get_element"])
    mcp.mount_http()
    import uvicorn
